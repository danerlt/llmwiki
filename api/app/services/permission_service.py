...
class PermissionService:
    async def accessible_kb_ids(self, session: AsyncSession, user: User) -> set[uuid.UUID]:
    ...
    async def can_write(self, session: AsyncSession, user: User, kb: KnowledgeBase) -> bool:
